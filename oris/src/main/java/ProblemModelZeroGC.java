...
public class ProblemModelZeroGC {
  public static void build(PetriNet net, Marking marking) {
    ...
    T_no.addFeature(StochasticTransitionFeature.newDeterministicInstance(new BigDecimal("0"), MarkingExpr.from("1", net)));
    T_no.addFeature(new Priority(0));
    T_service.addFeature(StochasticTransitionFeature.newExponentialInstance("0.0036"));
    T_yes.addFeature(StochasticTransitionFeature.newDeterministicInstance(new BigDecimal("0"), MarkingExpr.from("0", net)));
